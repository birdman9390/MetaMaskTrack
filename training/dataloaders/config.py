...
__C.PATH.ROOT = '/home/jaeyeop'

# Data folder
__C.PATH.DATA = osp.abspath(osp.join(__C.PATH.ROOT, 'DAVIS17_test'))
...
# Path to annotations
__C.PATH.DEFORMATIONS = osp.join(__C.PATH.DATA,"Deformations",__C.RESOLUTION)

# Color palette
__C.PATH.PALETTE = osp.abspath(osp.join(__C.PATH.ROOT, 'DAVIS17/palette.txt'))

# Paths to files
__C.FILES = edict()

# Path to property file, holding information on evaluation sequences.
__C.FILES.DB_INFO = osp.abspath(osp.join(__C.PATH.ROOT,"DAVIS17/db_info.yaml"))
